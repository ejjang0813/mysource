 ...
 */
@WebServlet("/cart/addCart2")
public class _ShoppingCartServlet extends HttpServlet {
	 ...
	 * 2-a-1 사용자가 장바구니에 담도록 요청한 상품이 없는경우 -> 상품목록(/cart/showItems)으로 이동.
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/cart/_cart_list.jsp").forward(request, response);
